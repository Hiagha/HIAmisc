...
```{r}
allSims <- read.table(file = "all_sim_data/simulation_analyses_0.4/simulation_data/Simulated.Data.100.Reps.Herit.0.4.txt",header=T,stringsAsFactors=F)
```
...
```{r}
setwd("all_sim_data/simulation_analyses_0.4")
...
write.csv(tworesults, file = paste("results.epistatic.0.4.csv"))
```
