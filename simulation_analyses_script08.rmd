...
```{r}
allSims <- read.table(file = "all_sim_data/simulation_analyses_0.8/simulation_data/Simulated.Data.100.Reps.Herit.0.8.txt",header=T,stringsAsFactors=F)
```
...
```{r}
setwd("all_sim_data/simulation_analyses_0.8")
...
write.csv(tworesults, file = paste("results.epistatic.0.8.csv"))
```
