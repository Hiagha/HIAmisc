...
```{r}
allSims <- read.table(file = "all_sim_data/simulation_analyses_0.9/simulation_data/Simulated.Data.100.Reps.Herit.0.9.txt",header=T,stringsAsFactors=F)
```
...
```{r}
setwd("all_sim_data/simulation_analyses_0.9")
