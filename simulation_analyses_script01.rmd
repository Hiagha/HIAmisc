...
```{r}
allSims <- read.table(file = "all_sim_data/simulation_analyses_0.1/simulation_data/Simulated.Data.100.Reps.Herit.0.1.txt",header=T,stringsAsFactors=F)
```
...
write.csv(tworesults, file = paste("results.epistatic.0.1.csv"))
```
